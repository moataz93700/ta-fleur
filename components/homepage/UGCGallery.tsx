...
const ugcPosts: UGCPost[] = [
  {
    id:     'u1',
    image:  'https://images.unsplash.com/photo-1490750967868-88df5691166b?w=400&q=80',
  ...
  {
    id:     'u4',
    image:  'https://images.unsplash.com/photo-1567696911980-2c669aff9db1?w=400&q=80',
